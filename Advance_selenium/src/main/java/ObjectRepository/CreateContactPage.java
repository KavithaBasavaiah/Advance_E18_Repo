...
public class CreateContactPage {
	 ...
	 WebDriver driver; // declaration initialized
		...
		public   CreateContactPage(WebDriver driver) // argument passed for constructor
		{
			this.driver=driver;
		...
		public void createContactWithCampaign(String org,String title,String cont,String mob,String childUrl,String parentUrl,String campName) throws InterruptedException
		{
